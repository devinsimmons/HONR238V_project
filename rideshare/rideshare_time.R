...
ggplot(data = daily_pattern, aes(x = hour, y = mean_ridership)) + geom_line(linetype = 'solid', col = 'springgreen3') + geom_point(col = 'springgreen4') + labs(x = 'Hour of the day', y = 'Mean Ridership', title = 'Uber Daily Ridership Pattern')
